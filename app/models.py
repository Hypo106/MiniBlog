...
article_types = {u'开发语言': ['Python', 'C#', 'JavaScript'],
                 'Linux': [u'Linux成长之路', u'Linux运维实战', 'CentOS', 'Ubuntu'],
                 u'网络技术': [u'思科网络技术', u'其它'],
                 u'数据库': ['PostgresSQL', 'MSSQL', 'Redis'],
                 u'日记': [u'生活那些事', u'学校那些事', u'感情那些事'],
                 u'Web开发': ['Flask', 'Django', 'Web.py'],
                 }
...
class User(UserMixin, db.Model):
    ...
    @property
    def password(self):
        raise AttributeError('password is nat a readable attribute')
...
class Menu(db.Model):
    ...
    @staticmethod
    def insert_menus():
        menus = [u'Web开发', u'数据库', u'网络技术', u'日记',
                 u'Linux世界', u'开发语言']
        for name in menus:
            menu = Menu(name=name)
            db.session.add(menu)
...
class ArticleType(db.Model):
    ...
    def insert_articleTypes():
        articleTypes = ['Python', 'C#', 'JavaScript', 'Django',
